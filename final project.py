...
score_font = pygame.font.SysFont("digital anarchy", 20)
...
def watermark(mark):
    value = score_font.render(str(mark), True, white)
    dis.blit(value, [dis_width / 2.7, dis_height / 2 ])


# Display a message on the screen when the game is over
def message(msg, color):
    mesg = font_style.render(msg, True, color)
    dis.blit(mesg, [dis_width / 3.6, dis_height / 2.5])
